...
Shader "BubbleShader"
{
	...
	SubShader
	{
		...
		{
			float2 temp_cast_0 = (( i.uv_texcoord.y + ( _Time.y * _Speed ) )).xx;
			float simplePerlin2D1 = snoise( temp_cast_0*10.0 );
			simplePerlin2D1 = simplePerlin2D1*0.5 + 0.5;
			float3 temp_cast_1 = (simplePerlin2D1).xxx;
...
/*ASEBEGIN
Version=18935
-75.2;377.6;1523.2;659;1232.647;200.2834;1;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;6;-972.7542,22.97888;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-1076.754,173.3791;Inherit;False;Property;_Speed;Speed;0;0;Create;True;0;0;0;False;0;False;0;0.43;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;2;-854.966,-185.8738;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-745.5551,56.5789;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;7;-606.3552,-60.22113;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;1;-252.4002,-54.40004;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;10;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=96C34168051D2E6670CC789B6320AEDDEAD5DBF4