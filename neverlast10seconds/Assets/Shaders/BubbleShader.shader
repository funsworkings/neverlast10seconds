...
Shader "BubbleShader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ase_vertexNormal * _VertexOffset );
			v.vertex.w = 1;
		}

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float simplePerlin2D1 = snoise( i.uv_texcoord*6.0 );
...
/*ASEBEGIN
Version=18935
-152;820;1523.2;655.8;1246.07;58.30129;1;True;False
Node;AmplifyShaderEditor.TexCoordVertexDataNode;2;-564.9,-156.6;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalVertexDataNode;4;-346.6497,50.22702;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;3;-466.9486,257.8225;Inherit;False;Property;_VertexOffset;Vertex Offset;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;1;-178.8,-147.2;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;6;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5;-108.2497,164.627;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=0D42F69332473016FEA277351FD5BD602888A2CA