...
Shader "RippleSkin"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_89_0 = ( ( ( smoothstepResult80 * 2.0 ) * ase_vertexNormal ) * _OffsetStrength );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float mulTime101 = _Time.y * 0.5;
			float2 temp_cast_0 = (mulTime101).xx;
...
/*ASEBEGIN
Version=18935
-26.4;581.6;1523.2;659;280.3031;784.4697;1.043477;True;False
Node;AmplifyShaderEditor.RangedFloatNode;98;-613.9481,1312.737;Inherit;False;Property;_Speed;Speed;13;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;34;-485.3595,-787.9315;Inherit;False;Property;_HoleUV;Hole UV;7;0;Create;True;0;0;0;False;0;False;1,1;50,50;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;101;91.17278,-452.3895;Inherit;False;1;0;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;100;260.605,-525.4121;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;99;505.6721,-536.9531;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;1434.835,1529.964;Inherit;False;Property;_OffsetStrength;OffsetStrength;12;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;92;920.925,-1097.833;Inherit;False;Property;_Color1;Color 1;10;0;Create;True;0;0;0;False;0;False;0.9056604,0.5416874,0.7765515,0;0.9056604,0.5416874,0.7765515,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;93;920.9247,-929.1586;Inherit;False;Property;_Color2;Color 2;11;0;Create;True;0;0;0;False;0;False;0.5660378,0.253115,0.253115,0;0.5660378,0.253115,0.253115,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;69;-735.6852,383.0453;Inherit;False;Property;_Vector2;Vector 2;9;0;Create;True;0;0;0;False;0;False;0,0,0;0,105.3,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=DFE9437D41D7898BEDF80EF5C13A56BFDF2EEA1B